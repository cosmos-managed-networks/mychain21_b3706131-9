...
HTTPS_GIT := github.com/mygithub/mychain21.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=mychain21 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c mychain21 --local -f chains.yaml
endif
