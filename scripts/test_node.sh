...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.mychain21" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.mychain21" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.mychain21"}")
export BINARY=${BINARY:-mybinary}
...
from_scratch () {
  ...
  # mybech321efd63aw40lxf3n4mhf7dzhjkr453axur9lfgrt
  ...
  # mybech321hj5fveer5cjtn4wd6wstzugjfdxzl0xpet6v2z
  ...
  # poa
  update_test_genesis '.app_state["poa"]["params"]["admins"]=["mybech3210d07y265gmmuvt4z0w9aw880jnsr700j99mmsj"]'
