...
var (
	...
	ChainImage = ibc.NewDockerImage("mychain21", "local", "1025:1025")
	...
	DefaultGenesis = []cosmos.GenesisKV{
		...
		cosmos.NewGenesisKV("app_state.poa.params.admins", []string{"mybech3210d07y265gmmuvt4z0w9aw880jnsr700j99mmsj", "mybech321hj5fveer5cjtn4wd6wstzugjfdxzl0xpet6v2z"}),
